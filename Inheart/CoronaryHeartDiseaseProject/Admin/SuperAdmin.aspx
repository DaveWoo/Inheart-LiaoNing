                    ...
                    <td class="menu">
                        <ul class="bigbtu">
                            ...
                            <li id="right"><a title="更新当前页面" onclick="window.parent['content3'].location.reload()"
                                style="cursor: pointer;">更新当前页面</a></li>
                        </ul>
                    </td>
                    <td class="tab">
                        <ul id="tabpage1">
                                        ...
                                        <div id="menu" class="menu">
                                            ...
                                            <div id="left_menu_cnt1" class="left_menu_cnt">
                                                <ul id="dleft_tab1">
                                                    ...
                                                    <li id="now10"><a title="管理医院" href="SuperManage/AdminManageHospital.aspx" onclick="show_title('管理医院')"
                                            ...
                                            <div id="left_menu_cnt2" class="left_menu_cnt">
                                                <ul id="dleft_tab2">
                                                    <li id="now31"><a title="添加管理员" onclick="show_title('添加管理员')" href="SuperManage/AddAdmin.aspx"
                                                        target="content3"><span>添加管理员</span></a></li>
                                                    <li id="now32"><a title="管理管理员" onclick="show_title('管理管理员')" href="SuperManage/AdminManage.aspx"
                                                        target="content3"><span>管理管理员</span></a></li>
                                                    <li id="now33"><a title="修改密码" onclick="show_title('修改密码')" href="SuperManage/AdminCenter.aspx"
                                            ...
                                            <div id="left_menu_cnt4" class="left_menu_cnt">
                                                <ul id="dleft_tab4">
                                                    ...
                                                    <li id="now16"><a title="查看日志" onclick="show_title('查看日志')" href="SuperManage/ViewLogs.aspx"
                                                        target="content3"><span>查看日志</span></a> </li>
                                                </ul>
                                            </div>
                                            <div class="clear">
                                            </div>
