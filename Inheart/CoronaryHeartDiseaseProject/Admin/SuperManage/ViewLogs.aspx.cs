namespace CoronaryHeartDiseaseProject.Admin.SuperManage
{
    ...
    public partial class ViewLogs : System.Web.UI.Page
    {
        ...
        private static SiteUser superAdmin;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                superAdmin = (SiteUser)Session["sa"];
                ...
                else
                {
                    ...
                    List<Log_Login> userLogList = SiteManagement.GetLogLogin(superAdmin.Hospital.ID);
        ...
        {
            int MaxAdminPages;
            if (SiteManagement.GetLogLogin(superAdmin.Hospital.ID) == null)
            {
                return 0;
            }

            TotalNums = SiteManagement.GetLogLogin(superAdmin.Hospital.ID).Count;
