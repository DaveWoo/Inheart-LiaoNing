namespace CoronaryHeartDiseaseProject
{
    ...
    public class BaseSystem
    {
        ...
        {
            string resultstring = "";
            resultstring += "<html><head><script type=\"text/javascript\" src=\"/Scripts/sweetalert.min.js\"></script>";
            resultstring += "<link rel=\"stylesheet\" type=\"text/css\" href=\"/Styles/sweetalert.css\" /></head>";
            resultstring += "<body>";
            resultstring += "<script language=\"javascript\">";
            resultstring += "swal(\"" + Msg + "\");";
