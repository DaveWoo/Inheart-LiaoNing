                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="0" cellspacing="0" class="styleLeft">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            是否再通:&nbsp;<asp:Label ID="rblPass" runat="server" />
                                                        </td>
                                                        <td>
                                                            并发症:
                                                        ...
                                                        <td>
                                                            是否出血：<asp:Label ID="chkBlood" AutoPostBack="true" runat="server" Text="出血 " />
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="styleLeft" class="tableWidth2">
                                        <tr>
                                            <td>
                                                阿斯匹林:<asp:Label ID="rblAspirinDosage" runat="server" />
                                            </td>
                                            <td>
                                                氯吡格雷:<asp:Label ID="rblClopidogrelDosage" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            是否应用他汀类药物:<asp:Label ID="rblLoadStatinUsed" runat="server" AutoPostBack="true" />
                                                        </td>
                                                        <td>
